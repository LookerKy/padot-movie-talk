    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                <Link
                    href="/"
                    className="text-2xl font-bold text-foreground tracking-tighter hover:opacity-80 transition-opacity"
                >
                    페닷 명화
                </Link>
                ...
                <nav className="flex items-center gap-8">
                    <div className="flex items-center gap-8 text-sm font-medium">
                        <Link
                            href="/"
                            className="text-foreground/80 hover:text-padot-blue-500 transition-colors relative group text-lg"
                        >
                            홈
                            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-padot-blue-500 transition-all group-hover:w-full" />
                        </Link>
                                ...
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" className="w-56 bg-popover border-border text-popover-foreground p-2">
                                        ...
                                        <DropdownMenuItem asChild>
                                            <Link
                                                href="/profile"
                                                className="cursor-pointer flex items-center gap-2 hover:bg-accent transition-colors py-2.5 rounded-md px-2 focus:bg-accent"
                                            >
                                        ...
                                        <DropdownMenuItem asChild>
                                            <button
                                                ...
                                                className="w-full cursor-pointer flex items-center gap-2 text-destructive hover:bg-destructive/10 transition-colors py-2.5 rounded-md px-2 mt-1 focus:bg-destructive/10"
                                            >
                                                <LogOut size={16} />
