    ...
    return (
        <div className="space-y-6">
            <div className="text-center md:text-left max-w-6xl mx-auto pt-8">
                <h1 className="text-4xl font-black bg-clip-text text-transparent bg-gradient-to-r from-padot-blue-500 to-purple-500 tracking-wider mb-2 animate-fade-in-up">
                    페닷 송충이 리포트
                </h1>
